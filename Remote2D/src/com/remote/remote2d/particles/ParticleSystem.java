...
public class ParticleSystem extends EditorObject {
	...
	public Vector2D environment = new Vector2D(0,1);
	...
	public boolean spawnParticle()
	{
		...
		Vector2DF randomVec = new Vector2DF((random.nextFloat()-0.5f)*2f,(random.nextFloat()-0.5f)*2f);
		
		Vector2D startPos = pos.add(startPosDeviation.multiplyVec(randomVec));
		randomVec = new Vector2DF((random.nextFloat()-0.5f)*2f,(random.nextFloat()-0.5f)*2f);
